...
function dependencies() {
  return { createAssetId: () => ASSET_ID, repository: { create: vi.fn(async (asset) => ({ ...asset, validated: true, createdAt: "created" })) }, objectStore: { write: vi.fn(), read: vi.fn(), delete: vi.fn() } };
}
