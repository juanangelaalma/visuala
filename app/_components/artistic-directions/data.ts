...
export const categoryData: Record<string, ItemType[]> = {
    ...
    Fashion: [
        { label: "OUTFIT BREAKDOWN / LOOKBOOK", img: null, video: "/videos/artistics/fashion/outfit_breakdown_lookbook.mp4" },
        { label: "DYNAMIC TRANSITION (JUMP CUT)", img: null, video: "/videos/artistics/fashion/dynamic_transition.mp4" },
        { label: "FABRIC MOVEMENT SLOW-MO", img: null, video: "/videos/artistics/fashion/fabic_movement_slowmo.mp4" },
        { label: "MONOCHROME VS COLOR POP", img: null, video: "/videos/artistics/fashion/monochrome_vs_color_pop.mp4" },
        { label: "STREET STYLE CINEMATIC", img: null, video: "/videos/artistics/fashion/street_style_cinematic.mp4" },
        { label: "MIX AND MATCH / STYLING GUIDE", img: null, video: "/videos/artistics/fashion/mix_and_match_styling.mp4" },
        { label: "CAPSULE WARDROBE AESTHETIC", img: null, video: "/videos/artistics/fashion/capsule_wardobe_aesthetic.mp4" },
        { label: "SILHOUETTES & SHADOWS PLAY", img: null, video: "/videos/artistics/fashion/silhouettes_and_shadows_play.mp4" },
        { label: "VINTAGE / RETRO EDITORIAL", img: null, video: "/videos/artistics/fashion/vintage_retro_editorial.mp4" },
        { label: "CLOSE-UP STITCHING & DETAIL", img: null, video: "/videos/artistics/fashion/close_up_stiching_and_detail.mp4" },
        { label: "AIRPORT / TRAVEL LOOK", img: null, video: "/videos/artistics/fashion/airport_travel_look.mp4" },
        { label: "GENDER-NEUTRAL / UNISEX STYLE", img: null, video: "/videos/artistics/fashion/gender_neutral_unisex_style.mp4" },
    ],
    Food: [
